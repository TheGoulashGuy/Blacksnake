...
import handClass #Don't forget to import winCheck and other needed modules

print('''
Welcome to Blacksnake, a Python implementation of Blackjack. *Gambing is not encouraged*
''')
...
while game_in_session == True:
	...
	if playerChoice == 'h':
		...
		#winCheck.wincheck() #This function will set game_in_session to false if someone has won, thus ending the main game loop.
		pass
	else:
